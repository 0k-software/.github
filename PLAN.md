...
- [x] [Step 2: Delete the plan-next skill](#step-2-delete-the-plan-next-skill)
- [x] [Step 3: Remove plan-next from README skills table](#step-3-remove-plan-next-from-readme-skills-table)
