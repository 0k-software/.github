...
- [ ] [Step 1: Fix refine/SKILL.md](#step-1-fix-refineskillmd)
- [ ] [Step 2: Fix plan-init/SKILL.md and plan-execute/SKILL.md](#step-2-fix-plan-initskillmd-and-plan-executeskillmd)
