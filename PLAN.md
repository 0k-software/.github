...
- [x] [Step 2: Evolve `fix-pr/SKILL.md` — merge in all `/fix` PR mechanics and 0k additions](#step-2-evolve-fix-prskillmd--merge-in-all-fix-pr-mechanics-and-0k-additions)
- [x] [Step 3: Split — extract `fix-issue`, rewrite router, add aliases, update issues #80 and #63](#step-3-split--extract-fix-issue-rewrite-router-add-aliases-update-issues-80-and-63)
