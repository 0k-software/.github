...
- [ ] [Step 1: Replace `wt switch` with `git checkout` on the main/master path](#step-1-replace-wt-switch-with-git-checkout-on-the-mainmaster-path)
- [ ] [Step 2: Add `git push` handling for non-main/master sessions](#step-2-add-git-push-handling-for-non-mainmaster-sessions)
